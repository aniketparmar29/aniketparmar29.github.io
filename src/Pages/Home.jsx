...
function Home() {
  ...
  return (
    <div name="Home">
        ...
        <div style={isDarkMode===true?{background:"#000006",color:"white"}:{backgroundColor:"#2874F0",color:"black"}} id='about' className='max-w-screen md:w-full  mx-auto pt-10 pb-20 md:pt-28 '>
