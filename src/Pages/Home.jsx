...
function Home() {
  ...
  return (
    <div name="Home">
        ...
        <div style={isDarkMode===true?{background:"#000006",color:"white"}:{backgroundColor:"white",color:"black"}} id='about' className='max-w-screen md:w-full home mx-auto pt-10 pb-20 md:pt-28 '>
        <div className="max-w-screen md:max-w-screen-lg text-center lg:text-left mx-auto grid lg:grid-cols-2 items-center">
            ...
            <TypeAnimation
              ...
              cursor={true}
                repeat={Infinity}
                // style={{ fontSize: '2rem' }}
                className={isDarkMode===true?"text-blue-500 xl:text-4xl text-2xl animate-none md:animate-pulse ":"text-blue-500 xl:text-4xl text-2xl animate-none md:animate-pulse z-0"}
            />
              </div>
