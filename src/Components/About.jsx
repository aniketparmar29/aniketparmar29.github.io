...
function About({isDarkMode}) {
  ...
  return (
    <div style={isDarkMode===true?{background:"#000006",color:"white"}:{backgroundColor:"#2874F0",color:"black"}} id='about' name="About" className='max-w-screen md:w-full  mx-auto pt-10 pb-20 md:pt-28 '>
