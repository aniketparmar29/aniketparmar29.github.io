...
function About({isDarkMode}) {
  ...
  return (
    <div style={isDarkMode===true?{backgroundColor:"teal",color:"white"}:{backgroundColor:"cyan",color:"black"}} id='about' name="About" className='max-w-screen md:w-full  mx-auto pt-10 pb-20 md:pt-28 '>
